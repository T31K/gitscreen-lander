...
export const accordionData = [
  {
    id: 1,
    title: "How does Gitscreen work ?",
    content:
      "You download the macOS app, set your username and Gitscreen retrieves your Github commit stats and turn them into a beautiful wallpaper.",
  },
  {
    id: 2,
    title: "Must I pay to use Gitscreen?",
    content:
      "No. You can use the free version which requires you to manually retrieve your Github commit stats. The premium version is completely optional.",
  },
  {
    id: 3,
    title: "How much is the premium version?",
    content: "It's $15.99. One time payment. Pay once and yours forever",
  },
  {
    id: 4,
    title: "Can I get a refund if I don't like the app?",
    content:
      "Yes. Full refund, no questions asked. However, you will no longer have access to the premium version.",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    content:
      "We accept payments through trusted and secure platforms such as Stripe. Gitsceen will never request any payment details directly. Instead, we provide secured checkout session within the app.",
  },
  {
    id: 7,
    title: "Does Gitscreen collect any personal data?",
    content: "No. Gitscreen does not collect any personal data.",
  },
  {
    id: 8,
    title: "What is Gitscreen built with??",
    content:
      "Gitscreen is a macOS app built with Tauri. The main goal was to design a powerful yet lightweight app.",
  },

  {
    id: 9,
    title: "Is Gitscreen affiliated with Github?",
    content:
      "No. Gitscreen is an independent entity and is not affiliated with Github or its entities in any way.",
  },
];
